...
export const sortQueryParamnsIndex = [
  ...
  { property: "flip", type: checkFlip }, // url: /image?flip=0 or 1
  { property: "xflip", type: checkFlip }, // url: /image?xflip=0 or 1
  { property: "yflip", type: checkFlip }, // url: /image?yflip=0 or 1
